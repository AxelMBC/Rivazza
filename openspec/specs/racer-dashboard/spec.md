...
Live race-engineering dashboard for an active Assetto Corsa session: instrument cluster, driving-aid status lights, lap timing with live delta, live pedal bars, G-force meter, and steering indicator, arranged in a dense motorsport-style layout around the track map.
