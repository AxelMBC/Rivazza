...
type Kernel32 = {
  openMapping: () => unknown; // HANDLE — null while AC isn't running locally
...
const loadKernel32 = async (): Promise<Kernel32 | null> => {
  try {
    ...
    return {
      openMapping: () => openFileMapping(FILE_MAP_READ, false, MAPPING_NAME),
